...
function Main({ movies, spinRef, onLoaded }) {
    ...
    return (
        <div className="main-container w-full md:ml-60">
            <p className=" text-orange-600 absolute right-1/2 md:left-1/2 top-2/4 text-3xl md:text-8xl animate-spin" ref={spinRef}><i className="fa fa-spinner" aria-hidden="true"></i></p>
